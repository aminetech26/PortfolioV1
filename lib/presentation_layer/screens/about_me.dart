...
class AboutMe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      CircleAvatar(maxRadius: 100.r,backgroundImage: const AssetImage(Strings.profilePicture),),
      SizedBox(width: size.width/10,),
      Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          FadeInUp(child: Text('About Me',style: TextStyles.headingStyles(),)),
          SizedBox(height: size.height/50,),
          Text('Software Developer !',style: TextStyles.montserratTextStyle(),),
          SizedBox(height: size.height/50,),
          Container(width: 200.w,child: Text('In the realm of technology, I stand as an ambitious, autonomous, and fast-learning individual who firmly believes that our only true limit is our imagination. I am constantly driven by an insatiable thirst for knowledge, always seeking opportunities for growth and learning.',style: TextStyles.normalText(),)),
          SizedBox(height: size.height/50,),
          FadeInUp(child: Text('Technical Skills',style: TextStyles.headingStyles(),)),
          SizedBox(height: size.height/50,),
          Row(children: [
          ...
          SizedBox(height: size.height/50,),
          FadeInUp(child: Text('Soft Skills',style: TextStyles.headingStyles(),)),
          SizedBox(height: size.height/50,),
          Row(children: [
      ...
      return Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            FadeInUp(child: Text('About Me',style: GoogleFonts.rubikMoonrocks(
            ...
            Text('Software Developer !',style: GoogleFonts.montserrat(
              fontWeight: FontWeight.bold,
              fontSize: 15.sp,
              color: Colors.black87,
            ),),
            SizedBox(height: size.height/70,),
            Container(width: 300.w,child: Text('In the realm of technology, I stand as an ambitious, autonomous, and fast-learning individual who firmly believes that our only true limit is our imagination. I am constantly driven by an insatiable thirst for knowledge, always seeking opportunities for growth and learning.',style: GoogleFonts.signikaNegative(
            ...
            SizedBox(height: size.height/70,),
            FadeInUp(child: Text('Technical Skills',style: GoogleFonts.rubikMoonrocks(
              fontWeight: FontWeight.w800,
              fontSize: 10.sp,
              letterSpacing: 2,
              color: Colors.black87,
            ...
            SizedBox(height: size.height/70,),
            FadeInUp(child: Text('Soft Skills',style: GoogleFonts.rubikMoonrocks(
              fontWeight: FontWeight.w800,
              fontSize: 10.sp,
              letterSpacing: 2,
              color: Colors.black87,
    ...
    return FadeInLeft(
      ...
      child: MaterialButton(onPressed: (){},
                  child: Text(name,style: GoogleFonts.montserrat(
                    ...
                    fontSize: fontSize,
                    color: Colors.black,
                  ),),color: Colors.lightBlueAccent,hoverColor: Colors.white,shape: OutlineInputBorder(borderRadius: BorderRadius.circular(3.r)),),
    );
  }
}
